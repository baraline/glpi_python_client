...
from glpi_python_client._sync.clients.api.administration._entity import EntityMixin
from glpi_python_client._sync.clients.api.administration._user import UserMixin
