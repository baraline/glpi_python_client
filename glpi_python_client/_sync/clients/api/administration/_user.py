"""GLPI ``/Administration/User`` mixin.
...
the transport mixin for HTTP dispatch.
"""
...
from glpi_python_client._sync.clients.commons._constants import USER_ENDPOINT, GlpiId
...
class UserMixin(TransportMixin):
    """CRUD helpers for ``/Administration/User``.
    ...
    def find_user_by_email(
        ...
        **This scans.** GLPI exposes e-mail addresses as ``User.emails``, a
        ...
        for batch in self.iter_search_users(
            rsql_filter,
