...
def test_search_documents_filter_and_pagination(client: Any) -> None:
...
def test_get_document_endpoint(client: Any) -> None:
...
def test_create_document_returns_id(client: Any) -> None:
...
def test_update_document_patches_endpoint(client: Any) -> None:
...
def test_delete_document_with_force(client: Any) -> None:
...
def test_download_document_returns_bytes(client: Any) -> None:
...
def test_download_document_raises_on_failure(client: Any) -> None:
...
def test_upload_document_requires_filename(client: Any) -> None:
...
def test_upload_document_dispatches_to_v1(client: Any) -> None:
...
def test_upload_document_without_v1_raises(client: Any) -> None:
...
def test_iter_search_documents_yields_every_page(client: Any) -> None:
    ...
    batches = [
        batch for batch in client.iter_search_documents("name==x", batch_size=3)
    ]
...
def test_iter_search_documents_stops_on_a_single_short_page(client: Any) -> None:
    ...
    batches = [batch for batch in client.iter_search_documents(batch_size=50)]

    assert starts == [0]
    assert len(batches) == 1


def test_iter_search_documents_yields_nothing_when_empty(client: Any) -> None:
