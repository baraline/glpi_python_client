...
class ContractMixin(TransportMixin):
    ...
    def search_contracts(
        ...
        *,
        ...
        if sort is not None:
            params["sort"] = sort
        return self._resource_list(CONTRACT_ENDPOINT, GetContract, params=params)

    def iter_search_contracts(
        self,
        rsql_filter: str = "",
        *,
        batch_size: int = 50,
        sort: str | None = None,
    ) -> Iterator[list[GetContract]]:
    ...
    def get_contract(self, contract_id: GlpiId) -> GetContract:
    ...
    def create_contract(self, contract: PostContract) -> int:
