"""GLPI ``/Assistance/Ticket/{id}/TeamMember`` mixin.
...
class TeamMemberMixin(TransportMixin):
    """Helpers for the ticket team-member endpoint."""
    ...
    def add_ticket_team_member(
        ...
        response = self._post_request(endpoint, self._body(member))
