...
def test_list_kb_article_comments_targets_nested_endpoint(client: Any) -> None:
...
def test_get_kb_article_comment_targets_per_id_endpoint(client: Any) -> None:
...
def test_create_kb_article_comment_returns_id(client: Any) -> None:
    rec = _Recorder()
    rec.install(client)
    new_id = client.create_kb_article_comment(
...
def test_update_kb_article_comment_sends_patch(client: Any) -> None:
    rec = _Recorder()
    rec.install(client)
...
def test_delete_kb_article_comment_with_force(client: Any) -> None:
    rec = _Recorder()
    rec.install(client)
