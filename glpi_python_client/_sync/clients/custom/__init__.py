...
:mod:`glpi_python_client._sync.clients.api`.
...
from glpi_python_client._sync.clients.custom._statistics import StatisticsMixin
from glpi_python_client._sync.clients.custom._ticket_context import TicketContextMixin
