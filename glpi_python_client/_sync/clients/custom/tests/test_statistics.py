...
def test_get_ticket_statistics_rejects_invalid_window(client: Any) -> None:
...
def test_get_task_statistics_zero_for_empty_input(client: Any) -> None:
...
def test_get_ticket_statistics_entity_id_filter(client: Any) -> None:
...
def test_get_ticket_statistics_entity_name_resolution(client: Any) -> None:
...
def test_get_ticket_statistics_entity_name_no_match(client: Any) -> None:
...
def test_get_ticket_statistics_extra_filter_appended(client: Any) -> None:
...
def test_get_ticket_statistics_default_days_window(client: Any) -> None:
...
def test_get_task_durations_empty_ticket_list(client: Any) -> None:
...
def test_get_task_durations_entity_grouping(client: Any) -> None:
...
def test_get_task_durations_return_task_details_true(client: Any) -> None:
...
def test_get_task_durations_return_task_details_false(client: Any) -> None:
...
def test_get_user_activity_raises_without_identifier(client: Any) -> None:
...
def test_get_user_activity_single_user_happy_path(client: Any) -> None:
...
def test_get_user_activity_raises_when_no_users_matched(client: Any) -> None:
...
def test_get_user_activity_multi_user_merge(client: Any) -> None:
...
def test_v1_task_statistics_matches_the_per_ticket_shape(client: Any) -> None:
