"""Shared construction logic for the GLPI client.
...
from glpi_python_client._sync._concurrency import Lock
...
class _BaseGlpiClient:
    ...
    :func:`build_client_resources` and the header, lock and state
    attributes the transport mixin declares.
    """
    ...
    def from_env(
        ...
        **overrides : object
            ...
            keyword overrides are forwarded verbatim.
