...
used by the per-endpoint mixins under :mod:`glpi_python_client._sync.clients.api`
and the higher-level helpers under :mod:`glpi_python_client._sync.clients.custom`.
"""
