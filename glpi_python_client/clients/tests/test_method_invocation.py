...
class _StubV1:
    ...
    def request_json(self, method: str, path: str, **kwargs: Any) -> Any:
        ...
        # Both shapes the v1 callers expect: a list for collection reads and
        # a dict carrying an id for writes.
...
def _install_stub(client: GlpiClient | AsyncGlpiClient) -> list[str]:
    ...
    client._session.request = _request  # type: ignore[method-assign,union-attr]
    ...
    client._v1 = _StubV1(calls)  # type: ignore[assignment]
    return calls
