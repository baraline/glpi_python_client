"""Synchronous GLPI ``/Knowledgebase/Article/{id}/Comment`` mixin.
...
class KBArticleCommentMixin(TransportMixin):
    """Synchronous CRUD helpers for KB article comments."""

    def list_kb_article_comments(self, article_id: GlpiId) -> list[GetKBArticleComment]:
