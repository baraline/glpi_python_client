"""Error formatting helpers for client-side exception handling.

The helpers here normalise messages produced by the third-party libraries
the transport layer relies on so higher-level mixins can log readable error
strings without depending on those libraries directly.
"""
