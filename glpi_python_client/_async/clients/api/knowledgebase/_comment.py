...
class KBArticleCommentMixin(TransportMixin):
    ...
    async def list_kb_article_comments(
    ...
    async def get_kb_article_comment(
    ...
    async def create_kb_article_comment(
    ...
    async def update_kb_article_comment(
        self,
        article_id: GlpiId,
        comment_id: GlpiId,
    ...
    async def delete_kb_article_comment(
        self,
        article_id: GlpiId,
        comment_id: GlpiId,
        *,
