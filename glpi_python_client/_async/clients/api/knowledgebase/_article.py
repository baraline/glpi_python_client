...
class KBArticleMixin(TransportMixin):
    ...
    async def create_kb_article(self, article: PostKBArticle) -> int:
        ...
        new_id = await self._resource_create(
            KB_ARTICLE_ENDPOINT,
            article,
        ...
        if article.categories:
            try:
                await self._apply_category_fallback(new_id, article.categories)
    ...
    async def update_kb_article(
        ...
        await self._apply_category_fallback(article_id, article.categories)
    ...
    async def set_kb_article_categories(
    ...
    async def _apply_category_fallback(
        ...
        for ref in categories:
            ...
            ids.append(ref.id)
        await self.set_kb_article_categories(article_id, ids)
