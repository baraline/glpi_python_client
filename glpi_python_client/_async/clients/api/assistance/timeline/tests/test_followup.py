...
async def test_list_ticket_followups_unwraps_envelope(client: Any) -> None:
...
async def test_get_ticket_followup_endpoint(client: Any) -> None:
...
async def test_update_ticket_followup_patch(client: Any) -> None:
...
async def test_delete_ticket_followup_force(client: Any) -> None:
...
async def test_create_ticket_followup_targets_timeline_endpoint(client: Any) -> None:
